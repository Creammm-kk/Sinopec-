...
def getdata0(file):
    ...
    for x in datas:
        ...
        #以上是防白蚁
        if x.find('低温') != -1 or x.find("HD") != -1 or x.find("耐寒") != -1:
...
def getdata1(file):
    ...
    for x in datas:
        dat = []  # 型号，耐火，阻燃等级，低烟无卤，防白蚁，低温，线芯数，相线截面，中线截面，地线截面，
        if x.find('YJV') != -1 or x.find("聚乙烯绝缘聚氯乙烯护套") != -1:
            if x.find('BPYJVP') != -1 or x.find("变频") != -1:
                dat.append('BPYJVP')
            else:
                dat.append('YJV')
        if x.find('YJY') != -1 or x.find("聚乙烯绝缘聚乙烯护套") != -1:
            if x.find('BPYJYP') != -1 or x.find("变频") != -1:
                dat.append('BPYJYP')
            else:
                dat.append('YJY')
        if x.find('GG') != -1:
        ...
        # 以上是耐火
            if x.find('A') != -1:
                ...
                dat.append('C')
        # 以上是阻燃
        if x.find('低烟无卤') != -1 or x.find("WD") != -1:
            dat.append('low_smoke')
        else:
            dat.append('smoke')
        # 以上是低烟无卤
        ...
        # else:
        #     dat.append('no_sheild')
        if x.find('22') != -1 or ((x.find('钢带铠装') != -1) and (x.find("聚氯乙烯护套") != -1)) and x.find('mm22') == -1:
            dat.append('22')
        elif x.find('23') != -1:
            dat.append('23')
        elif x.find('32') != -1 or ((x.find('钢丝缠绕铠装') != -1) and (x.find("聚氯乙烯护套") != -1)) and x.find('mm32') == -1:
            dat.append('32')
        elif x.find('33') != -1:
            dat.append('33')
        elif x.find('钢丝铠装') != -1:
